...
namespace JSONRPC
{
  ...
  public:
    ...
    static JSONRPC_STATUS ExecuteVoiceCommand(const std::string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result);
  };
}
